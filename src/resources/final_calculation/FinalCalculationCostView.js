          ...
          <Table selectable={false}>
            ...
            <TableBody displayRowCheckbox={false}>
              <TableRow>
                ...
                <TableHeaderColumn style={textCenterAlign}>
                  Pcs / Unit One
                </TableHeaderColumn>
              </TableRow>
              <TableRow>
                <TableRowColumn colSpan={2}>
                  {this.props.record.raw_material_name}
                </TableRowColumn>
                <TableRowColumn style={textRightAlign}>
                  ${this.props.record.raw_material_cost}
                </TableRowColumn>
                <TableRowColumn style={textCenterAlign}>
                  {this.props.record.number_of_pieces_per_unit_one}
                </TableRowColumn>
                <TableRowColumn style={textRightAlign}>
                  <b>${this.props.record.raw_calculated}</b>
                </TableRowColumn>
              </TableRow>
              <TableRow>
              ...
              <TableRow>
                <TableRowColumn>
                  {this.props.record.colorant_one}
                </TableRowColumn>
                <TableRowColumn style={textRightAlign}>
                  ${this.props.record.color_one_cost}
                </TableRowColumn>
                <TableRowColumn style={textCenterAlign}>
                  {this.props.record.number_of_pieces_per_unit_one}
                </TableRowColumn>
                <TableRowColumn style={textCenterAlign}>
                  {this.props.record.percentage_of_colorant_one}
                </TableRowColumn>
                <TableRowColumn style={textRightAlign}>
                  <b>${this.props.record.fina_color_one_cost}</b>
                </TableRowColumn>
              </TableRow>
              <TableRow>
                <TableRowColumn>
                ...
                <TableRowColumn style={textRightAlign}>
                  ${this.props.record.color_two_cost}
                </TableRowColumn>
                <TableRowColumn style={textCenterAlign}>
                  {this.props.record.number_of_pieces_per_unit_two}
                </TableRowColumn>
                <TableRowColumn style={textCenterAlign}>
                  {this.props.record.percentage_of_colorant_two}
                </TableRowColumn>
                <TableRowColumn style={textRightAlign}>
                  <b>${this.props.record.fina_color_two_cost}</b>
                </TableRowColumn>
              </TableRow>
              <TableRow>
                <TableRowColumn colSpan={5} style={textRightAlign}>
                  <b>Total Cost($)</b>
                </TableRowColumn>
                <TableRowColumn style={textRightAlign}>
                  <b>${this.props.record.total_cost}</b>
                </TableRowColumn>
              </TableRow>
            </TableBody>
          </Table>
            ...
            <TableBody displayRowCheckbox={false}>
              {typeof this.props.record.blank_final_calculations_view ===
                ...
                <TableRow>
                  <TableRowColumn
                    ...
                    rowSpan={
                      this.props.record.blank_final_calculations_view.length + 4
                    }
                  >
                    Blank
                  </TableRowColumn>
              ...
              {typeof this.props.record.blank_final_calculations_view ===
                ...
                <TableRow>
                  ...
                  <TableRowColumn style={textRightAlign}>
                    <b>
                      {this.props.record.blank_final_calculations_view.length}
                    </b>
                  </TableRowColumn>
                </TableRow>
              )}
