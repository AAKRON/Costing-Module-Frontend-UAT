...
class VendorExportModal extends React.Component {
  ...
  fetchRawMaterials = () =>
    restClient(GET_LIST, "vendors-list-only", {
  ...
  handleSeletedBlankPriceCostDownload = (e) => {
    ...
    window.open(
      `${SERVER_URL}/vendors-download/vendors-listing.csv?blanks=${this.state.seleted_blanks.toString()}`,
      "_blank"
    );
  };
      ...
      <span>
        ...
        >
          <div style={styles.CenterAlgin}>
            ...
            <AutoComplete
              floatingLabelText={`Type the vendor name`}
