...
class RawMaterialTypeExportModal extends React.Component {
  ...
  handleSeletedBlankPriceCostDownload = (e) => {
    ...
    window.open(
      `${SERVER_URL}/raw-material-type-download/listing-raw-material.csv?blanks=${this.state.seleted_blanks.toString()}`,
      '_blank'
    );
  };
  ...
  render() {
    ...
    return (
      <span>
        <FlatButton
          primary
          label='Export Raw Material Types'
          onTouchTap={this.handleOpen}
          icon={<FileFileDownload />}
        />
        <Dialog
          title='Export Raw Material Types List'
          modal={false}
        ...
        >
          <div style={styles.CenterAlgin}>
            ...
            <h2 style={{ marginBottom: 0 }}>
              Export Selected Raw Material Types
            </h2>
            <AutoComplete
              floatingLabelText={`Type the Raw Material Type name`}
            ...
            {this.state.seleted_blanks.length > 0 && (
              <RaisedButton
                style={styles.RaisedButton.FirstButton}
                label='Export Selected Raw Materials Types'
                primary={true}
                onTouchTap={this.handleOpen}
                icon={<FileFileDownload />}
